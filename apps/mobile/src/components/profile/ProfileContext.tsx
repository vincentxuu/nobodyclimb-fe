import type { Biography, User } from '@nobodyclimb/types'
...
function mapBiographyToProfileData(biography: Biography | null): Partial<ProfileData> {
  ...
  const advancedStories: AdvancedStories = {
    // A. 成長與突破
    memorable_moment:
      ((biography as unknown as Record<string, unknown>).memorable_moment as string) || '',
    biggest_challenge:
      ((biography as unknown as Record<string, unknown>).biggest_challenge as string) || '',
    breakthrough_story:
      ((biography as unknown as Record<string, unknown>).breakthrough_story as string) || '',
    first_outdoor:
      ((biography as unknown as Record<string, unknown>).first_outdoor as string) || '',
    first_grade: ((biography as unknown as Record<string, unknown>).first_grade as string) || '',
    frustrating_climb:
      ((biography as unknown as Record<string, unknown>).frustrating_climb as string) || '',
    // B. 心理與哲學
    fear_management:
      ((biography as unknown as Record<string, unknown>).fear_management as string) || '',
    climbing_lesson:
      ((biography as unknown as Record<string, unknown>).climbing_lesson as string) || '',
    failure_perspective:
      ((biography as unknown as Record<string, unknown>).failure_perspective as string) || '',
    ...
    unexpected_gain:
      ((biography as unknown as Record<string, unknown>).unexpected_gain as string) || '',
    // C. 社群與連結
    climbing_mentor:
      ((biography as unknown as Record<string, unknown>).climbing_mentor as string) || '',
    climbing_partner:
      ((biography as unknown as Record<string, unknown>).climbing_partner as string) || '',
    funny_moment: ((biography as unknown as Record<string, unknown>).funny_moment as string) || '',
    favorite_spot:
      ((biography as unknown as Record<string, unknown>).favorite_spot as string) || '',
    advice_to_group:
      ((biography as unknown as Record<string, unknown>).advice_to_group as string) || '',
    climbing_space:
      ((biography as unknown as Record<string, unknown>).climbing_space as string) || '',
    // D. 實用分享
    injury_recovery:
      ((biography as unknown as Record<string, unknown>).injury_recovery as string) || '',
    memorable_route:
      ((biography as unknown as Record<string, unknown>).memorable_route as string) || '',
    training_method:
      ((biography as unknown as Record<string, unknown>).training_method as string) || '',
    effective_practice:
      ((biography as unknown as Record<string, unknown>).effective_practice as string) || '',
    technique_tip:
      ((biography as unknown as Record<string, unknown>).technique_tip as string) || '',
    ...
    climbing_trip:
      ((biography as unknown as Record<string, unknown>).climbing_trip as string) || '',
    bucket_list_story:
      ((biography as unknown as Record<string, unknown>).bucket_list_story as string) || '',
    climbing_goal:
      ((biography as unknown as Record<string, unknown>).climbing_goal as string) || '',
    climbing_style:
      ((biography as unknown as Record<string, unknown>).climbing_style as string) || '',
    climbing_inspiration:
      ((biography as unknown as Record<string, unknown>).climbing_inspiration as string) || '',
    // F. 生活整合
    life_outside_climbing:
      ((biography as unknown as Record<string, unknown>).life_outside_climbing as string) || '',
  }
