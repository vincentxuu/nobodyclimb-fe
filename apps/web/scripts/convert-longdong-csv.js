...
function main() {
  ...
  const longdongData = {
    crag: {
      ...
      descriptionEn:
        "Long Dong is Taiwan's most iconic outdoor climbing destination, located in Gongliao District, New Taipei City. It features spectacular coastal cliffs and diverse climbing routes, making it the largest natural crag in Taiwan with the most routes.",
      videoUrl: '',
      images: [
        ...
        transportation: [
          {
            ...
            descriptionEn:
              'From Taipei, take National Highway 1 to Provincial Highway 2 (Coastal Highway), about 1.5 hours drive',
          },
          {
            type: '大眾運輸',
  ...
  for (const [_area, _count] of Object.entries(areaStats)) {
  }
}
