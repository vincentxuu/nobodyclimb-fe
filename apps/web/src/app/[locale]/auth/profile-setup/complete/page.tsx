...
export default function CompletePage() {
  ...
  const handleChoiceSubmit = useCallback(
    async (optionId: string, customText?: string, followUpText?: string) => {
      ...
      return {
        responseMessage: result?.response_message || t('thankYouAnswer'),
      ...
      try {
        ...
        if (Object.keys(oneLinersData).length > 0) {
          ...
          toast({
            ...
            description: t('biographyUpdated'),
            variant: 'default',
          })
        }
          ...
          {isSaving ? (
            <div className="flex min-h-screen items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-[#6D6C6C]">{t('saving')}</p>
              </div>
            </div>
          ) : (
            <GuidedQuestions
              ...
              title={t('guidedQuestionsTitle')}
              subtitle={t('guidedQuestionsSubtitle')}
            />
          )}
        </div>
      </PageTransition>
          ...
          <div className="flex justify-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-xs sm:text-sm">{t('stepBasicInfo')}</span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-xs sm:text-sm">{t('stepTags')}</span>
              </div>
              <div className="h-1 w-8 sm:w-12 bg-primary"></div>
              <div className="flex flex-col items-center">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary text-white">
                ...
                <span className="mt-2 text-xs sm:text-sm">{t('stepOneLiner')}</span>
              </div>
              <div className="h-1 w-8 sm:w-12 bg-primary"></div>
              <div className="flex flex-col items-center">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary text-white">
                ...
                <span className="mt-2 text-xs sm:text-sm">{t('stepComplete')}</span>
              </div>
            </div>
          </div>
        </div>
