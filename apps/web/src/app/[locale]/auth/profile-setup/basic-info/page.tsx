...
export default function BasicInfoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: t('updateFailed'),
        description: t('updateErrorRetry'),
        variant: 'destructive',
      })
    } finally {
    ...
    <PageTransition>
      <div className="container mx-auto max-w-4xl px-4 py-8">
          ...
          <div className="flex justify-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-xs sm:text-sm text-gray-500">{t('stepTags')}</span>
              </div>
              <div className="h-1 w-8 sm:w-12 bg-gray-300"></div>
              <div className="flex flex-col items-center">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-300 text-gray-600">
                ...
                <span className="mt-2 text-xs sm:text-sm text-gray-500">{t('stepOneLiner')}</span>
              </div>
              <div className="h-1 w-8 sm:w-12 bg-gray-300"></div>
              <div className="flex flex-col items-center">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-300 text-gray-600">
                ...
                <span className="mt-2 text-xs sm:text-sm text-gray-500">{t('stepComplete')}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 text-center">
          <h1 className="text-2xl font-bold">{t('basicInfoTitle')}</h1>
        </div>
