            ...
            <div className="rounded-lg bg-white p-6 shadow-sm lg:p-8">
              ...
              <div className="mb-8">
                <div
                  ...
                  role="img"
                  aria-label={t('coverImageAriaLabel', {
                    name: currentCrag.name,
                    rockType: currentCrag.rockType || t('outdoorClimbing'),
                  })}
                >
                  <CragCoverGenerator
                  ...
                  <div className="mt-4">
                    ...
                    <div className="overflow-hidden rounded-lg">
                      <iframe
                        ...
                        title={t('cragMapIframeTitle', { name: currentCrag.name })}
                      />
                    </div>
                  </div>
                ) : (
                  <div className="mt-4 flex h-48 items-center justify-center rounded-lg bg-gray-200">
                    <span className="text-gray-500">{t('mapUnavailable')}</span>
                  </div>
                )}
              </div>
                      ...
                      >
                        ...
                        <div className="p-3">
                          ...
                          <div className="mt-1 text-xs text-gray-500">
                            {t('areaRouteCount', { count: area.routesCount })}
                          </div>
                        </div>
                      </Link>
                    ))}
