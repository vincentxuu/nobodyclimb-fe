  ...
  if (!person) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <p className="text-lg text-[#6D6C6C]">{t('profileNotFound')}</p>
        <Link href="/biography">
    ...
    <div className="min-h-screen bg-page-content-bg">
      ...
      <div className="bg-[#dbd8d8] py-10">
        <div className="container mx-auto px-4">
          <h2 className="mb-8 text-center text-2xl font-medium">{t('recommendedTitle')}</h2>
      ...
      {!user && (
        <div className="bg-[#1B1A1A] py-12">
          <div className="container mx-auto max-w-2xl px-4 text-center">
            ...
            <p className="mb-6 text-sm text-gray-300 md:text-base">{t('guestCtaDesc')}</p>
