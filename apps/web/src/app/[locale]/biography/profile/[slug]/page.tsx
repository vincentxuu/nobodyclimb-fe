...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'BiographyPage' })
  ...
  return {
    title: person.name,
    description,
    keywords: [person.name, t('metaKeyword1'), t('metaKeyword2'), t('metaKeyword3')],
    openGraph: {
    ...
    alternates: {
      ...
      languages: buildHreflangAlternates(`/biography/profile/${slug}`),
    },
  }
}
