  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-6">
          <Breadcrumb
            items={[
              ...
              { label: t('exploreLocationsTitle'), href: '/biography/explore/locations' },
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 flex items-center gap-2 text-emerald-600">
              ...
              <span className="text-lg font-medium">
                {t('visitorsHereCount', { count: location.visitor_count })}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <h2 className="mb-6 text-xl font-medium text-gray-900">{t('visitorsListTitle')}</h2>
