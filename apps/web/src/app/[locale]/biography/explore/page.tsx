...
export default function ExplorePage() {
  ...
  const filterTabs: { value: FilterTab; label: string }[] = [
    ...
    { value: 'growth', label: t('filterGrowth') },
    { value: 'experience', label: t('filterExperience') },
    { value: 'recovery', label: t('filterRecovery') },
    { value: 'footprint', label: t('filterFootprint') },
  ]
  ...
  return (
    ...
    >
      <PageHeader title={t('explorePageTitle')} subtitle={t('explorePageSubtitle')} />
