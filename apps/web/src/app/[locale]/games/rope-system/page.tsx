      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        ...
        >
          <div className="flex items-center gap-4 rounded-xl border border-[#E5E5E5] bg-white p-4">
            ...
            <div>
              <h3 className="font-medium text-[#1B1A1A]">{t('learnMode.title')}</h3>
              <p className="text-sm text-[#535353]">{t('learnMode.description')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 rounded-xl border border-[#E5E5E5] bg-white p-4 opacity-50">
            ...
            <div>
              <h3 className="font-medium text-[#1B1A1A]">{t('examMode.title')}</h3>
              <p className="text-sm text-[#535353]">{t('examMode.comingSoon')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 rounded-xl border border-[#E5E5E5] bg-white p-4 opacity-50 sm:col-span-2 lg:col-span-1">
            ...
            <div>
              <h3 className="font-medium text-[#1B1A1A]">{t('certificationMode.title')}</h3>
              <p className="text-sm text-[#535353]">{t('certificationMode.comingSoon')}</p>
            </div>
          </div>
        </motion.div>
