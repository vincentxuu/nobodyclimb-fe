...
export const STAGE_LABELS: Record<string, string> = {
  ...
  multi_tool: '多工具組合執行',
  mmr_selection: 'MMR 多樣性選取',
  popularity_rerank: '熱門度加權排序',
  generation: 'LLM 生成回答',
...
export function StageIcon({ name, skipped }: { name: string; skipped: boolean }) {
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    text_to_sql: <Database className={cls} />,
    ...
    popularity_rerank: <ArrowUpDown className={cls} />,
