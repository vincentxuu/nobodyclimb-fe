  ...
  return (
    <section className={cn('py-6', className)}>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-900">找到我</h2>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        {activeSocials.map(([platform, value]) => (
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 transition-colors"
          >
            <span className="text-gray-600">{SocialIcon[platform]}</span>
