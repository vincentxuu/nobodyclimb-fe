...
CREATE TABLE IF NOT EXISTS user_ranks (
  ...
  score INTEGER NOT NULL DEFAULT 0,                            -- 當前等級積分
  rank_id TEXT NOT NULL DEFAULT 'foothill',                    -- 當前等級 ID
  ...
  rank_override_id TEXT,                                       -- 管理員手動覆寫等級（NULL 表示自動計算）
  created_at TEXT DEFAULT (datetime('now')),
