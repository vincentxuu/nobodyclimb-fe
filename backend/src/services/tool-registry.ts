...
registry.register({
  ...
  description:
    '精確計數/統計/篩選/資料查詢（如「有幾條」「列出」「幾顆bolt」「FA是誰」「最多」「各難度」「我完攀了幾條」「我有幾條rp」）',
  triggerSignals: [
    '有幾條',
    '幾條路線',
    '有哪些路線',
...
registry.register({
  ...
  displayName: '混合推薦查詢',
  description:
    '推薦型查詢，需要 SQL 候選集 + LLM 推薦（如「推薦我幾條龍洞的初級路線」「推薦適合入門的路線」，且有指定岩場或具體條件）',
...
registry.register({
  ...
  displayName: '多工具組合查詢',
  description:
    '同時涉及兩種以上不同需求的複合查詢（如同時需要統計數據和語義推薦、同時查詢路線資訊和岩場資訊），與 hybrid 的區別：hybrid 是「SQL篩選+LLM推薦」固定組合，multi_tool 是任意工具的自由組合',
